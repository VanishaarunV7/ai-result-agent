...
const programs = {
  "P_CS": ["Mathematics", "DBMS", "Python Programming", "Data Structures", "Computer Networks"],
  "P_BT": ["Genetics", "Biochemistry", "Microbiology", "Cell Biology"],
  "P_CA": ["Accounts", "Auditing", "Taxation", "Cost Accounting"]
};

// Flatten to get all courses to seed
const coursesToSeed = [...programs.P_CS, ...programs.P_BT, ...programs.P_CA];
